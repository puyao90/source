...
function setup()
{
	...
	robot1Speed_x = random(0, 2);
	robot1Speed_y = random(0, 2);
...
function draw()
{
	...
	//robot heads
	fill(200);
	rect(robot1_x, robot1_y, 100, 100);
	rect(robot2_x, robot2_y, 100, 100);
	...
	if (antenna1) { fill(250, 250, 0); } else {
		fill(255,0,0)
	}
	 if (frameCount/100==parseInt(frameCount/100)) { antenna1=!antenna1}
	...
	// if (robot1_x + 100 >= 600 || robot1_y >= 700) {
	// 	robot1Speed_x *= -1; robot1Speed_y *= -1
	// } else if (robot1_x - 100 <= 0 || robot1_y <= 0) {
	// 	robot1Speed_x *= -1; robot1Speed_y *= -1
	// }
	if (robot1_x + 100 >= 600) {
		robot1Speed_x *= -1
	}
	else if (robot1_y >= 700) {
		robot1Speed_y *= -1
	}
	else if (robot1_x + 100 <= 0) {
		robot1Speed_x *= -1
	}
	else if (robot1_y <= 0) {
		robot1Speed_y *= -1
	...
	else if (robot2_y >= 700) {
		robot2Speed_y *= -1
	}
	else if (robot2_x + 100 <= 0) {
		robot2Speed_x *= -1
	}
	else if (robot2_y <= 0) {
		robot2Speed_y *= -1
