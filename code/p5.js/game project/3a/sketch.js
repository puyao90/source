...
function setup() {
  ...
  isLeft = isRight = isPlummeting = isFalling = false;
}
...
function draw() {
  ...
  noStroke();
  fill(0, 155, 0);
  rect(0, floorPos_y, width - 200, width - floorPos_y); //draw some green ground

  //tree
  fill(color("#A5694B"));
  rect(treePos_x - 70 - 300 + 520, treePos_y + 105, 18, 40);
  rect(treePos_x - 70 + 70 - 320 + 520, treePos_y + 105 - 40, 18, 80);
  fill(color("#3BB900"));
  triangle(
    treePos_x - 70 + 10 - 300 + 520,
    treePos_y + 105 - 92,
    treePos_x - 70 - 15 - 300 + 520,
    treePos_y + 105,
    treePos_x - 70 + 35 - 300 + 520,
    treePos_y + 105
  );
  triangle(
    treePos_x - 70 + 10 + 70 - 320 + 520,
    treePos_y + 105 - 92 - 20,
    treePos_x - 70 - 15 + 60 - 320 + 520,
    treePos_y + 105 - 10,
    treePos_x - 70 + 35 + 80 - 320 + 520,
    treePos_y + 105 - 10
  );

  //canyon
  fill(0);
  rect(canyon.x_pos + 40, floorPos_y, canyon.width - 16, width - floorPos_y);
  ...
  function drawFallingCharacter() {
    fill(color("#EACC86"));
    rect(gameChar_x - 16, gameChar_y - 60, 32, 30); //head
    fill(color("#DE2A38"));
    rect(gameChar_x - 14, gameChar_y - 30, 28, 16); //body
    fill(color("#3E7CB9"));
    rect(gameChar_x - 6 - 18, gameChar_y - 50, 12, 12); //left arm
    rect(gameChar_x - 6 + 18, gameChar_y - 50, 12, 12); //right arm
    fill(color("#893240"));
    rect(gameChar_x - 6 - 8, gameChar_y - 12, 12, 8); //left leg
    rect(gameChar_x - 6 + 8, gameChar_y - 12, 12, 8); //right leg
  }
