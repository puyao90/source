/*
Officer: 7817938
CaseNum: 601-0-53260457-7817938
...
function setup() {
  ...
  noFill();
  stroke(0, 128, 128);
  for (var i = 0; i < Suspect_Sightings_coordinate_x.length; i++) {
    ellipse(
      Suspect_Sightings_coordinate_x[i],
      Suspect_Sightings_coordinate_y[i],
      5
    );
  }
}
