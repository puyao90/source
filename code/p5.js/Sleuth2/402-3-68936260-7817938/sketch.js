...
Officer: 7817938
CaseNum: 402-3-68936260-7817938
...
function draw() {
  ...
  if (det.locationX > 698) {
    det.speedX = 0;
    det.speedY = 1;
  }
  if (det.locationY > 258) {
    det.speedX = -1;
    det.speedY = 0;
  }

  if (det.locationX < 260 && det.locationY > 258) {
    det.speedX = 0;
    det.speedY = 1;
  }

  if (det.locationY > 447) {
    det.speedX = 1;
    det.speedY = 0;
  }
  if (det.locationX > 826) {
    det.speedX = 0;
    det.speedY = 1;
  }
  if (det.locationY > 573) {
    det.speedX = -1;
    det.speedY = 0;
  }
  if (det.locationX < 448 && det.locationY > 573) {
    det.speedX = 0;
    det.speedY = 1;
  }
  ...
  if (det.locationX > 761 && det.locationY > 632) {
    det.speedX = 0;
    det.speedY = 1;
  }
