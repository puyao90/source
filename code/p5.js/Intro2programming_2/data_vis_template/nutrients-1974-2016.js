function NutrientsTimeSeries() {
  ...
  this.draw = function () {
    ...
    drawYAxisTickLabels(this.minPercentage, this.maxPercentage, this.layout, this.mapPayGapToHeight.bind(this), 0);
    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      for (var j = 1; j < numYears + 2; j++) {
        ...
        if (previous != null) {
          ...
          var xLabelSkip = ceil(numYears / this.layout.numXTickLabels); //42years,5

          // Draw the tick label marking the start of the previous year.
          if (j % xLabelSkip == 0 && i == 0) {
