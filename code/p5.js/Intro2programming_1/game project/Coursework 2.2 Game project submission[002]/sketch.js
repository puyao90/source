...
class Fishs {
  ...
  update() {
    ...
    if (
      450 >= this.y &&
      450 < this.y + this.currentSpeed &&
      this.world.character.gameChar_world_x < 2037 &&
      this.world.character.gameChar_world_x < 1650
    ) {
...
class Assets {
  constructor() {
    ...
    this.waterSplashSound.setVolume(0.2);
    ...
    this.fireSound.setVolume(0.07);
    this.ufoSound = loadSound('assets/ufo.wav');
    this.ufoSound.setVolume(0.1);
    this.ufoRays = loadSound('assets/ufoRays2.wav');
    this.ufoRays.setVolume(0.05);
  }
}
